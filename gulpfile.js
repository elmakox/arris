...
function scssLint() {
  ...
  return src(['src/assets/scss/**/*.scss', '!src/assets/scss/vendors/*.scss'])
    .pipe(sassLint({
...
function deploy() {
  return src('/*')
    .pipe(ghPages({
      remoteUrl: 'https://bitbucket.org/godwinelitcha/sass-bootstrap-boilerplate.git',
      branch: 'master',
...
// PRODUCTION
exports.production = series(cleanDist, compileSCSS, copyFont, copyImages, compileHTML, concatScripts, minifyScripts, minifyCss, renameSources, prettyHTML,browserSyncInit);
